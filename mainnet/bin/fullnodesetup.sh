      ...
      olclient=https://github.com/Oneledger/protocol/releases/download/v0.18.13/olclient
      olfullnode=https://github.com/Oneledger/protocol/releases/download/v0.18.13/olfullnode
