      ...
      config_data_url=https://raw.githubusercontent.com/Oneledger/fullnode/main/mainnet/v0.18
      ...
      rm $OLDATA/consensus/config/genesis.json && wget https://raw.githubusercontent.com/Oneledger/fullnode/main/mainnet/v0.18/genesis.json -O $OLDATA/consensus/config/genesis.json
