      ...
      config_data_url=https://raw.githubusercontent.com/Oneledger/validator-deployment/main/mainnet/$config_version
      
      ##Get Binaries
      binary_version=v0.18.13
      ...
      rm $OLDATA/consensus/config/genesis.json && wget https://raw.githubusercontent.com/Oneledger/validator-deployment/main/mainnet/$config_version/genesis.json -O $OLDATA/consensus/config/genesis.json
